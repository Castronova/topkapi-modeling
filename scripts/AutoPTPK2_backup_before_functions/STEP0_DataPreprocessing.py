...
#
# DEM = arcpy.GetParameterAsText(6)               # after it is downloaded
# land_use = arcpy.GetParameterAsText(7)          # after it is downloaded
# outDir= arcpy.GetParameterAsText(8)             # output directory
# gage = arcpy.GetParameterAsText(9)              # boundary
# threshold = arcpy.GetParameterAsText(10)        # Threshold for defining stream
# # gage = arcpy.GetParameterAsText(5)            # Outlet point for the catchment
#
# path2ssurgoFolders = arcpy.GetParameterAsText(11)
# outDir = arcpy.GetParameterAsText(12)           # output raster and the projected polygon shapefile will be saved
# MatchDEM = arcpy.GetParameterAsText(13)

import STEP1_Get_DEM_LANDUSE
